...
namespace Ge
{
	...
	bool ValidationLayer::Initialize(VkInstance instance)
	{
		...
		Debug::Info("Initialisation de la ValidationLayer");
		return true;
	}

	void ValidationLayer::Release(VkInstance instance)
	{
		...
		Debug::Info("Liberation du ValidationLayer");
	}
